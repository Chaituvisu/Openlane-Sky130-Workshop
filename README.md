...
## 1.Introduction
    I. Brief about SoC/Processor architecture
    II.Overview of modules in SoC
    III.Nominclature of SoC as one of the packages QFN-48 ( Quad Flat No leads 48 pin) with typically size of 7mm x 7mm chip placed in middle of package connected to pins with wire bonds.
 ![](Snippets/2CHIP.bmp)
